...
NOTE:
THE FILES DigitalSignerApplet.jar AND DigitalSignerApplet.jks INSIDE THE 'xhtml' directory, MORE THE DIRECTORIES 'certificate', 'deploy' AND THE CONTENTS INSIDE THEY CANNOT BE COMMITED TO THE SERVER SVN.	